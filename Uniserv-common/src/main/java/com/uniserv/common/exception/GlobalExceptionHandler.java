...
public class GlobalExceptionHandler {
    ...
    public ResultUtils<?> handleNotLoginException(NotLoginException e) {
        ...
        return ResultUtils.<Void>error(ResultCode.NOT_LOGIN.getCode(), ResultCode.NOT_LOGIN.getMessage());
    }

    @ExceptionHandler(NotRoleException.class)
    public ResultUtils<?> handleNotRoleException(NotRoleException e) {
        log.error("角色异常: {}", e.getMessage(), e);
        return ResultUtils.<Void>error(ResultCode.AUTH_ERROR.getCode(), "无权访问当前页面");
    }
    ...
    public ResultUtils<?> handleException(Exception e) {
        ...
        return ResultUtils.<Void>error(ResultCode.SYSTEM_ERROR.getCode(), msg);
    }
}
